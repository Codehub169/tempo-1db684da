...
const ScrollIndicator = () => {
  return (
    <a 
      ...
      className="scroll-indicator absolute bottom-8 left-1/2 -translate-x-1/2 w-7 h-11 border-2 border-brand-neutral/70 rounded-full opacity-0 animate-fadeIn animation-delay-1500 group transition-opacity hover:opacity-80"
    >
      <span 
