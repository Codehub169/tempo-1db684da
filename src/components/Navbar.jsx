  ...
  return (
    <nav 
      className={`fixed top-0 left-0 w-full z-50 transition-all duration-500 ease-in-out print:hidden 
                  ...
                  bg-brand-beige backdrop-blur-md border-b border-black/[.05] dark:border-white/[.05]`}
    ...
    >
      <div className="container-custom h-full flex items-center justify-between">
        <a 
          ...
          className="text-2xl font-poppins font-medium text-brand-text-primary dark:text-brand-text-primary hover:text-brand-coral dark:hover:text-brand-coral transition-colors duration-300"
              ...
              <a 
                ...
                className={`relative text-sm font-inter py-2 nav-link-underline 
                            ${activeSection === item.id 
                              ...
                              : 'font-normal text-brand-text-primary dark:text-brand-text-primary hover:text-brand-coral dark:hover:text-brand-coral'}
        ...
        <div className="md:hidden">
          <button 
            ...
            className="p-2 rounded-md text-brand-text-primary dark:text-brand-text-primary hover:text-brand-coral dark:hover:text-brand-coral focus:outline-none focus:ring-2 focus:ring-inset focus:ring-brand-coral"
          >
            {isMobileMenuOpen ? (
      ...
      {isMobileMenuOpen && (
        <div 
          ...
          className="md:hidden absolute top-[var(--nav-height)] left-0 w-full bg-brand-beige shadow-xl py-4 animate-fadeIn"
        >
                ...
                <a 
                  ...
                  className={`text-lg py-2 px-4 rounded-md 
                              ${activeSection === item.id 
                                ...
                                : 'font-normal text-brand-text-primary dark:text-brand-text-primary hover:text-brand-coral dark:hover:text-brand-coral hover:bg-brand-coral/5'}
